...
namespace Kevin.Framework.Infrastructure
{
    ...
    public static partial class JsonHelper
    {
        ...
        /// <typeparam name="T">T</typeparam>
        /// <param name="json">json</param>
        /// <param name="anonymousTypeObject">T</param>
        /// <returns>T</returns>
        public static T DeserializeJsonAnonymousType<T>(string json, T anonymousTypeObject)
        {
            if (string.IsNullOrWhiteSpace(json))
                return default(T);
        ...
        {
            return DeserializeJsonList<T>(json);
        }
        ...
        /// <returns></returns>
        public static T DeserializeAnonymous<T>(this string json, T anonymousObject)
        {
            return DeserializeJsonAnonymousType<T>(json, anonymousObject);
        }
    }
            ...
            if (!string.IsNullOrEmpty(json))
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < json.Length; i++)
                    {
                        ...
                        {
                            string item = json.Substring(i);
                            int length = GetValueLength(item, false, out int temp);
